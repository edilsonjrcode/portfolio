      ...
      <Styled.Container>
        <Styled.BoxAbout>
          ...
          <Styled.BoxTexts>
            ...
            <SharedStyle.ParagrathSections align="right" widthrectangle="36.1875rem">Olá, meu nome é Edilson Júnior, sou Desenvolvedor Frontend com 2 anos de experiência. Moro em João Pessoa - PB, e sou apaixonado por criar interfaces modernas, intuitivas e acessíveis. Minha jornada como desenvolvedor começou com um forte interesse em transformar ideias em experiências digitais cativantes.
